...
| command-output-discipline | mutable directory; migrated from HM | `https://github.com/addyosmani/agent-skills.git@54c5adfc6b3b494b834d7c61a8feb41c9b5db083`, path `skills/debugging-and-error-recovery` | none | `28444af5a2bca14b6a4ac5c71b18e284fa19e790b249429d9196946f8e7599fa` |
| context-budgeting | mutable directory; migrated from HM | same revision, path `skills/context-engineering` | none | `37e875ac1c64d50025a87c5ee3c1bf07e24f91f64c27bc38bb22436edb20417f` |
...
| Root | Skills |
| --- | --- |
| `~/.codex/skills` | `dispatching-parallel-agents`, `subagent-driven-development` |
